...
public class JyperionListener implements ITestListener {
    ...
    public void onStart(ITestContext context) {
        log("onStart("+context+")");
        try {
            PdfWriter.getInstance(document, new FileOutputStream(context.getName() + ".pdf"));
        } catch (Exception e) {
            e.printStackTrace();
        }
        this.document.open();
        ...
        try {
            ...
            this.document.add((Element) new Paragraph(new Date().toString()));
    ...
    public void onFinish(ITestContext context) {
        ...
        try {
            if (this.failTable != null) {
                ...
                this.document.add((Element) this.failTable);
            ...
            if (this.successTable != null) {
                ...
                this.document.add((Element) this.successTable);
                this.successTable.setSpacingBefore(15f);
            }
        } catch (Exception e) {
        ...
        for(Integer key : keys) {
            ...
            try {
                this.document.add((Element) throwTitlePara);
            } catch (DocumentException e1) {
                // TODO Auto-generated catch block
                e1.printStackTrace();
            }
            ...
            for(StackTraceElement ste : elems) {
                //com.itextpdf.text.Element throwParagraph = (com.itextpdf.text.Element) new Paragraph(ste.toString());
                try {
                  //  this.document.add((Element) throwParagraph);
                } catch (Exception e) {
                    // TODO Auto-generated catch block
                    e.printStackTrace();
                }
